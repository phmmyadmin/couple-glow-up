...
export default function DishesView({
  ...
  return (
    <div className="space-y-6 sm:space-y-7">
      {/* Top Header Card */}
      <Card className="p-5 sm:p-6 bg-gradient-to-r from-indigo-900 via-indigo-800 to-slate-900 text-white rounded-2xl shadow-md border border-indigo-700/50 space-y-4">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <Button
            ...
            className="bg-white text-indigo-950 hover:bg-indigo-50 font-extrabold shadow-sm shrink-0 flex items-center gap-2"
          >
        ...
        {/* Search & Counter Bar */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-2 border-t border-indigo-700/40">
          <div className="relative w-full sm:w-72">
            ...
            <input
              ...
              className="w-full bg-indigo-950/60 border border-indigo-600/50 rounded-xl pl-9 pr-3 py-1.5 text-xs text-white placeholder-indigo-300/70 focus:outline-hidden focus:border-indigo-400"
            />
          </div>

          <span className="text-xs font-bold text-indigo-300 font-mono self-end sm:self-center">
            {filteredDishes.length} Dish{filteredDishes.length !== 1 ? 'es' : ''} Saved
          </span>
        </div>
      </Card>
