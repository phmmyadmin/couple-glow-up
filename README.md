...
[![Gemini AI](https://img.shields.io/badge/Google_Gemini-3.5_Flash-4285F4?style=for-the-badge&logo=google&logoColor=white)](https://ai.google.dev/)
[![PWA Ready](https://img.shields.io/badge/PWA-InjectManifest-F43F5E?style=for-the-badge&logo=pwa&logoColor=white)](https://web.dev/progressive-web-apps/)
[![Vitest](https://img.shields.io/badge/Tests-42%2F42_Passing-729B1B?style=for-the-badge&logo=vitest&logoColor=white)](https://vitest.dev/)
...
```mermaid
graph TD
    User["👤 Couple (Partner A & Partner B)"] --> App["📱 Couple Glow Up (PWA Shell)"]
    
    subgraph "Frontend Engine (React 19 + Tailwind v4)"
        App --> Fit["🥗 Fit Tracker (AI & Meal Prep)"]
        App --> Gym["🏋️ Gym Logger (1RM & Live Timer)"]
        App --> Shop["🛒 Shopping (Sync & Price Comparator)"]
        App --> Feed["💖 Feed & Milestones (Push Notifs)"]
    end
    
    subgraph "Optimization Layer"
        Fit --> Hook["⚡ useInfiniteScroll (60 FPS Progressive Windowing)"]
        Gym --> Hook
        Shop --> Hook
        Gym --> Audio["🔊 Web Audio Keep-Alive + Background Worker"]
    end

    subgraph "Cloud Backend & AI"
        Fit --> Gemini["🤖 Google Gemini 3.5 Flash (<2s Latency)"]
        Fit --> Supabase[("⚡ Supabase PostgreSQL + Realtime Sync")]
        Gym --> Supabase
        Shop --> Supabase
        Feed --> Supabase
    end
